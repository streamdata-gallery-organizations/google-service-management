...
- name: Google Service Management API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-service-management/master/_listings/google-service-management/v1-resource-testiampermissions-post.md
x-common:
- type: x-change-log
